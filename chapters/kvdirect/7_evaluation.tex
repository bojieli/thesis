...
\midrule
\textbf{键值-Direct (1 网卡)} & Programmable 网卡, two Gen3 x8 & PCIe \& DRAM & 180 & 114 & 1487 (5454) & 942 (3454) & 4.3 & 5.4 \\
\textbf{键值-Direct (10 网卡s)} & Programmable 网卡, one Gen3 x8 each & PCIe \& DRAM & 1220 & 610 & 3417 (4518) & 1708 (2259) & 4.3 & 5.4 \\
\bottomrule
\end{tabular}
...
如表 \ref {kvdirect:tab:kvs-compare} 所示，键值-Direct 网卡的吞吐量与具有数十个CPU核心的最先进的键值存储服务器相当。

\subsubsection{能耗效率}

插入键值-Direct 网卡可为空闲服务器增加10.6 W的功率。
...
当单个网卡 键值-Direct处于峰值负载时，我们的测量结果对服务器上的其他工作负载的影响最小。
