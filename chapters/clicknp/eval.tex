...
展望未来，FPGA技术仍在迅速发展。例如，Altera的下一代FPGA Arria 10的面积是本文使用的芯片（Stratix V）的2.5倍。
因此，我们认为高层次综合的面积成本将来将受到较少的关注。
